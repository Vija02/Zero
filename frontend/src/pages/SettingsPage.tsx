...
export function SettingsPage() {
	...
	useEffect(() => {
		if (data) {
			...
			if (daysInAdvanceRecord)
				setDaysInAdvance(daysInAdvanceRecord.value || "30")
		}
	}, [
		data,
		clientIdRecord,
			...
			<div className="space-y-6">
				...
				<div className="bg-[#111213] border border-[#252525] rounded-lg p-6">
					...
					<p className="text-sm text-[#888] mb-6">
						...
						access token. Make sure you've entered your OAuth credentials above
						first.
					</p>
				...
				<div className="bg-[#111213] border border-[#252525] rounded-lg p-6">
					...
					<p className="text-sm text-[#888] mb-6">
						Configure which calendars to sync and how far in advance to create
						tasks.
					</p>
					...
					{!isAuthenticated && (
						<div className="mb-6 p-3 rounded-md text-sm bg-yellow-900/30 text-yellow-400 border border-yellow-800 flex items-start gap-2">
							...
							<span>
								Please connect to Google Calendar above to enable these
								settings. Once authenticated, you'll be able to select which
								calendars to use.
							</span>
						</div>
					)}
					...
					<div className="space-y-4">
						...
						<div>
							...
							<p className="mt-1 text-xs text-[#666]">
								How many days ahead to create tasks from calendar events.
								Default is 30 days.
							</p>
						</div>
					</div>
